...
services.onclick = () => {
    ...
    bigtext.textContent = 'Social media hacking ( Not including Emails) :- $100   #social_media_hack   Email hacking Service :- $150   #email_hacking                                        Email hacking for custom website domains :- $200';
    text.textContent = '';
